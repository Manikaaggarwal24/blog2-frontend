...
const AddComment = ({ setSidebarShowStatus, slug, getStoryComments, activeUser, count }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        try {
            await axios.post(`https://blog2-backend-api.onrender.com/comment/${slug}/addComment`, { content, star }, {
                headers: {
            ...
            {activeUser.username &&
                ...
                <form className='addComment-form' onSubmit={handleSubmit}>
                    ...
                    <div className={showStatus ? 'activeuser-info ' : 'activeuser-info hidden '}>
                        <img src={`https://blog2-backend-api.onrender.com/userPhotos/${activeUser.photo}`} alt={activeUser.username} />
